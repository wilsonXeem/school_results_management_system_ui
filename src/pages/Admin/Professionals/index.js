...
function Professionals() {
  ...
  const filename = useMemo(() => 
    `${session}: ${level} Level: ${semester === "1" ? "first semester" : "second semester"} professional results`,
      ...
      <>
        ...
        <div className="current_level" style={{ textAlign: "center", padding: "2rem" }}>
          <div className="error-message" style={{ color: "red" }}>
            <h3>Error loading professional results</h3>
            <p>{error}</p>
    ...
    <>
      ...
      >
        <div className="header">
          <h2>
            {session}: {level} Level:{" "}
            {semester === "1" ? "first semester" : "second semester"} professional results
          </h2>
        </div>
        {load && <Loader />}
